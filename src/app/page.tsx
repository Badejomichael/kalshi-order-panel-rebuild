...
export default function PremiumOrderPanel() {
  ...
  // FIXED: currency is now typed safely EUR: <FaEuroSign className="text-gray-600 dark:text-gray-300" />, BTC: <FaBitcoin className="text-amber-500" />,
  const currencyIcon = {
          ...
          <div className="mt-4">
            ...
            <div className="mt-2 relative rounded-lg border border-gray-100 dark:border-neutral-700 bg-white/70 dark:bg-neutral-900/40 p-3 shadow-sm flex items-center">
              ...
              <input
                ...
                placeholder="0.00"
                className="input-reponsiveness ml-[-40] md:ml-0 flex-3 md:flex-1 bg-transparent outline-none text-right text-lg font-bold text-slate-900 dark:text-slate-100"
              />
